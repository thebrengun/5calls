...
function scriptFormat(issue: Issue, locationState: LocationState, contact: Contact) {
...
export const Script: React.StatelessComponent<Props> = ({ issue, currentContact, locationState }: Props) => {
