...
const nameMap = {
  ...
  'CT-ChristopherMurphy': {
    name: 'Chris Murphy (D-CT)',
    party: 'D',
    state: 'CT'
  },
  'CT-RichardBlumenthal': {
    name: 'Richard Blumenthal (D-CT)',
    party: 'D',
    state: 'CT'
  },
  'DE-ChristopherACoons': {
    name: 'Chris Coons (D-DE)',
    party: 'D',
    state: 'DE'
  },
  ...
  'NH-JeanneShaheen': {
    name: 'Jeanne Shaheen (D-NH)',
    party: 'D',
    state: 'NH'
  },
  'NH-MargaretWoodHassan': {
    name: 'Maggie Hassan (D-NH)',
    party: 'D',
    state: 'NH'
  },
  ...
  'NM-MartinHeinrich': {
    name: 'Martin Heinrich (D-NM)',
    party: 'D',
    state: 'NM'
  },
  'NM-TomUdall': { name: 'Tom Udall (D-NM)', party: 'D', state: 'NM' },
  'NV-CatherineCortezMasto': {
    name: 'Catherine Cortez Masto (D-NV)',
    party: 'D',
    state: 'NV'
  },
  'NV-DeanHeller': { name: 'Dean Heller (R-NV)', party: 'R', state: 'NV' },
  'NY-CharlesESchumer': {
    name: 'Chuck Schumer (D-NY)',
    party: 'D',
    state: 'NY'
  },
  'NY-KirstenEGillibrand': {
    name: 'Kirsten Gillibrand (D-NY)',
    party: 'D',
    state: 'NY'
  },
  ...
  'RI-SheldonWhitehouse': {
    name: 'Sheldon Whitehouse (D-RI)',
    party: 'D',
    state: 'RI'
  },
  'SC-LindseyGraham': {
    name: 'Lindsey Graham (R-SC)',
    party: 'R',
    state: 'SC'
  },
  ...
  'WV-ShelleyMooreCapito': {
    name: 'Shelley Moore Capito (R-WV)',
    party: 'R',
    state: 'WV'
  },
...
const definitelyNo: string[] = ['AK-LisaMurkowski'];
for (const senatorName in nameMap) {
  if (nameMap[senatorName].party !== 'R') {
...
const definitelyYes: string[] = ['WV-JoeManchin'];
  ...
  return (
    <div className="tracker">
      ...
      <div className="tracker__votes">
        <div
          className="tracker__votes__no"
          style={{ width: `${noVotes.length}%` }}
        >
          Opposes
        </div>
        <div
          className="tracker__votes__yes"
          style={{ width: `${yesVotes.length}%` }}
        >
          Supports
        </div>
      ...
      {props.includeList && (
        <div className="tracker__lists">
          <ul className="tracker__lists__no">
            ...
            {noVotes.map(senator => (
              <li
                key={nameMap[senator].name}
                className={`party_${nameMap[senator].party}`}
              >
                {nameMap[senator].name}
              </li>
            ))}
          </ul>
